...
<head>
  ...
  <title>Aso Luxe — Admin Orders</title>
  <style>
...
<script>
  ...
  async function viewOrder(orderId) {
    ...
    document.getElementById('modal-body').innerHTML = `
      ...
      <div class="detail-row"><strong>Total:</strong> Rs ${order.total_amount.toLocaleString()}</div>
